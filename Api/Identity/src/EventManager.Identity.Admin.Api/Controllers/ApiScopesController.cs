...
using EventManager.Identity.Admin.Api.Dtos.ApiResources;
using EventManager.Identity.Admin.Api.Dtos.ApiScopes;
...
namespace EventManager.Identity.Admin.Api.Controllers
{

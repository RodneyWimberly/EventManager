...
using EventManager.Identity.STS.Identity.Helpers.Localization;
using EventManager.Identity.STS.Identity.ViewModels.Manage;

namespace EventManager.Identity.STS.Identity.Controllers
{    
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("EventManager.Identity.STS.Identity"),

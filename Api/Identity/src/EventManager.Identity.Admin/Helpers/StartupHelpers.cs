using EventManager.Identity.Admin.Configuration;
...
using EventManager.Identity.Admin.ExceptionHandling;
using EventManager.Identity.Admin.Helpers.Localization;
...
namespace EventManager.Identity.Admin.Helpers
{

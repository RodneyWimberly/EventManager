...
namespace EventManager.DataAccess.Accounts
{
    public class AccountManager : IAccountManager
    {
        ...
        public async Task<(User User, string[] Roles)?> GetUserAndRolesAsync(string userId)
        {
        ...
        public async Task<(bool Succeeded, string[] Errors)> CreateUserAsync(User user, IEnumerable<string> roles, string password)
        {
        ...
        public async Task<(bool Succeeded, string[] Errors)> UpdateUserAsync(User user, IEnumerable<string> roles)
        {

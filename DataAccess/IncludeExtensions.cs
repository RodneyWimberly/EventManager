namespace EventManager.DataAccess
{
    ...
    {/*
        private static readonly MethodInfo IncludeMethodInfo = typeof(EntityFrameworkQueryableExtensions).GetTypeInfo()
            .GetDeclaredMethods(nameof(EntityFrameworkQueryableExtensions.Include)).Single(mi => mi.GetParameters().Any(pi => pi.Name == "navigationPropertyPath" && pi.ParameterType.Name == "String"));
        ...
        public static IIncludableQueryable<TEntity, object> Include<TEntity>(this IQueryable<TEntity> source, params string[] propertyPaths)
            where TEntity : class
        {
            ...
            return (IIncludableQueryable<TEntity, object>)query;
        }
        */
    }
}

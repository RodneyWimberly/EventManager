...
namespace EventManager.Identity
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.ConfigIdentityDbContext(_config);
            services.AddScoped<IIdentityManager, IdentityManager>();
            services.AddIdentity<User, Role>(a => a = _config.GetSection("IdentityOptions").Get<IdentityOptions>())
            ...
            services.AddExternalIdentityProviders(_config);
            ...
            services.AddAuthentication()
                /*.AddOpenIdConnect(GoogleDefaults.AuthenticationScheme, GoogleDefaults.DisplayName, options =>
                 ...
                 .AddGoogle(options =>
                 {
                     ...
                     options.ClientId = authenticationOptions.GetValue<string>("GoogleClientId");
                     options.ClientSecret = authenticationOptions.GetValue<string>("GoogleClientSecret");
                     //options.CallbackPath = "http://localhost:5000/callback";
                     //options.Scope.Add("email");
                 })

  ...
  where TEntity : class, IPrimaryKeyEntity<string>, IAuditableEntity, new()
    {
        ...
        public EntityControllerHelper(IHttpContextAccessor httpAccessor, IMapper mapper, IUnitOfWork unitOfWork, ILogger logger)
        {
        ...
        public async Task<IActionResult> Get(string id, string includePropertyPaths = "")
        {
            TEntity entity;
            if (string.IsNullOrEmpty(includePropertyPaths))
            {
        ...
        public async Task<IActionResult> Update(string id, string includePropertyPaths = "", TEntity entity = null)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    return HandleDbUpdateConcurrencyException(ex);
                }
            }
            else
            {
        ...
        protected IActionResult HandleDbUpdateConcurrencyException(DbUpdateConcurrencyException ex)
        {

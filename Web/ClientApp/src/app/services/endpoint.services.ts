...
export class EventEndpointService extends BaseEndpointService {
    ...
    getAllEventsPaged(pageNumber: number, pageSize: number): Observable<Event[]> {
    ...
    putEvent(id: number, entity: Event): Observable<void> {
        let url_ = this.baseUrl + "/api/Event/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processPutEvent(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    patchEvent(id: number, patch: Operation[]): Observable<void> {
        let url_ = this.baseUrl + "/api/Event/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processPatchEvent(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
